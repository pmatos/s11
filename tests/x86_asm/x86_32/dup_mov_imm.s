...
// syscall (`mov ebx, eax; mov eax, 1; int 0x80`) so the e2e behavioral tier
// (#837, `outcome-x86-32-dup-mov-collapse`) can run it directly; the exit
// code is 5, a checksum of the live-out EAX value. Register/immediate only
// — the x86 IR models no memory operands.
