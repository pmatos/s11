...
# Depends on build-tests since outcome cases (issue #834+) need fixtures
# assembled under tests/e2e/fixtures/; cargo builds the s11 binary itself
# via CARGO_BIN_EXE_s11.
e2e: build-tests
