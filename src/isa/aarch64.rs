...
mod tests {
    ...
    /// expected near 789 hits; the old sub-mux would give ~197, with the old
    /// branch measuring about 241 ANDS hits for this seed. MIN_EXPECTED sits
    /// ~6.8σ below the new expected and ~22σ above the old. The lower
