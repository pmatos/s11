...
pub const AARCH64_REWRITABLE_MNEMONICS: &[&str] = &[
    "mov", "movi", "mvn", "neg", "negs", "movn", "movz", "movk", "add", "sub", "adds", "subs",
    "adc", "adcs", "sbc", "sbcs", "and", "ands", "orr", "eor", "bic", "bics", "orn", "eon", "lsl",
    "lsr", "asr", "ror", "mul", "madd", "msub", "mneg", "smulh", "umulh", "sdiv", "udiv", "cmp",
    "cmn", "tst", "ccmp", "ccmn", "csel", "csinc", "csinv", "csneg", "cset", "csetm", "clz", "cls",
